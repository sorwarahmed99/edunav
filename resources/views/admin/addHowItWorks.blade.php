...
<div class="container">
  <h1 class="h3 mb-2 text-white text-center">Add How it works</h1>
  <div class="card o-hidden border-0 shadow-lg my-5">
    <div class="card-header">
        <h3><span><a href="{{ route('howItWorksAdmin') }}" class="btn btn-primary">Go Back</a></span></h3>
      </div>
    <div class="card-body p-0">
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="p-5">
            <form class="user" action="{{ route('addhowItWorksStore') }}" method="POST" enctype="multipart/form-data">
              @CSRF
              @if($errors->any())
