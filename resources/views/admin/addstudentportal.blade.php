...
<div class="container">
  <h1 class="h3 mb-2 text-white text-center">Add Student Portal info</h1>
  <div class="card o-hidden border-0 shadow-lg my-5">
    <!-- <div class="card-header">
			<h1 class="h4 mb-0 text-primary">Add Student portal info</h1>
		</div> -->
    <div class="card-body p-0">
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="p-5">
            <form class="user" action="{{ route('addstudentportalStore') }}" method="POST" enctype="multipart/form-data">
              @CSRF
              @if($errors->any())
