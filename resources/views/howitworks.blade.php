...
<section>
    <div class="header-inner two">
      <div class="inner text-center">
        <h4 class="title text-white uppercase">How Uninav Works</h4>
        <h5 class="text-white uppercase">Get to know More about us</h5>
      </div>
  ...
  <section>
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h3>How Uninav Works</h3>
          </div>
          <div class="col-md-6 text-right">
            <div class="pagenation_links"><a href="index.html">Home</a><i> / </i> <a href="index.html">How Uninav-360 Works</a></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 bmargin">
          ...
          @foreach ($hows as $uk)
              ...
              <div class="blog-post-info"> <span><i class="fa fa-user"></i> Author</span> </div>
              <br/>
              <p>
